# Generated by Django 5.1.1 on 2025-03-06 16:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shared', '0011_merge_20250223_0135'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prevention_control', models.JSONField(blank=True, default=dict, null=True)),
                ...
                ('scraper_source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='new_species', to='shared.scraperurl')),
            ],
            options={

...
class TestScraperAPIView:
    ...
    @patch(
        "src.apps.shared.api.viewsets.scraperFixture_viewsets.SCRAPER_FUNCTIONS",
        new_callable=dict,
    )
    ...
    @patch("src.apps.shared.api.viewsets.scraperFixture_viewsets.SCRAPER_FUNCTIONS", new_callable=dict)

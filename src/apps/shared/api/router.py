...
from .viewsets.scraperURL_viewsets import SpeciesViewSet, ReportComparisonDetailView, ToggleNotificationAPIView
...
urlpatterns = [
    ...
    path("report-comparison/<int:scraper_id>/", ReportComparisonDetailView.as_view(), name="report-comparison-detail"),
    path("api/notifications/toggle/", ToggleNotificationAPIView.as_view(), name="toggle-notification"),
